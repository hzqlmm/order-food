...
<div class="header">
	<div class="x_logo" id="id_login_div"><a href="<?php echo cls_config::get("dirpath","base");?>/" target="_blank"><img width="120px" height="40px" src="/webcss/admin/images/logo.png"></a></div>
